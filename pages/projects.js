    ...
    <div>
      ...
      <div>
        ...
        <p>This is the website you're currently on! This website serves as my little corner of the
          ...
          through <a href="http://www.digitalocean.com">digitalocean.com</a> 
        </p><br/>
        <h5><strong>Grammar Guru:</strong></h5>
        <p>This project was a game of hangman that was coded in Javascript and hosted on a Node.js
          ...
          with multiple color, font and difficulty selections to choose from.
        </p>
        <ul>
          <li>GitHub page: <a href="https://github.com/motocru/GrammarGuru">Grammar Guru</a></li>
        ...
        <p>This is a stat viewing application for the video game Quake Champions. The application
          ...
          for each of the in game weapons. Total Kills for each weapon as well as the ranks for 
          the different competitive modes. The original version of this application was written as a
          bot for Discord, another version is usable on this website, both are written in Javascript.
        </p>
        <ul>
          <li>GitHub page: <a href="https://github.com/motocru/quakeBot">Quake Bot</a></li>
          <li>Discord Application Page: <a href="https://discordapp.com/developers/applications/489141612786483205/information">
        ...
        <p>Curse bot is an application that tracks different levels of profanity on Discord servers.
          ...
          for both servers and individual users through the use of a MongoDB database. When milestones
        ...
        <ul>
          <li>GitHub Page: <a href="https://github.com/motocru/curse-bot">Curse Bot</a></li>
          <li>Discord Application Page: <a href="https://discordapp.com/developers/applications/544133743632187403/information">
          Curse Bot</a></li>
        </ul>
      </div>
    </div>
